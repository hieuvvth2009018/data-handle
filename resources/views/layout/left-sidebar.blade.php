<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="index.html"><img class="main-logo" src="/assert/asset/img/logo/logo.png" alt="" /></a>
            <strong><a href="index.html"><img src="/assert/assert/img/logo/logo.png" alt="" /></a></strong>
        </div>
